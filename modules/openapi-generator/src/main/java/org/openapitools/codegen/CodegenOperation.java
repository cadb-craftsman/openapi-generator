...
public class CodegenOperation {
    ...
    public String path, operationId, returnType, returnTypeBean, returnTypeEntity, returnFormat, httpMethod, returnBaseType, returnBaseTypeBean, returnBaseTypeEntity,
